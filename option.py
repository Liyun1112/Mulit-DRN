...
parser = argparse.ArgumentParser(description='MDRN')

parser.add_argument('--n_threads', type=int, default=0,  # 6
...
parser.add_argument('--seed', type=int, default=1,
                    help='random seed')
parser.add_argument('--data_dir', type=str, default='data',  # data_path
                    help='dataset directory')
parser.add_argument('--data_train', type=str, default='DF2K',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='DF2K',
                    help='test dataset name')
parser.add_argument('--data_range', type=str, default='1-3540/3541-3550',  # 1-800/801-810
...
parser.add_argument('--model', help='model name: MDRN-S', required=True)
...
parser.add_argument('--test_only', action='store_true',  # store_true
...
parser.add_argument('--save', type=str, default='./experiment/train/',
